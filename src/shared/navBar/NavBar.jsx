    ...
    <nav className="bg-[#15151580] border-gray-200 dark:bg-gray-900 px-6 py-2">
      <div className="flex flex-wrap items-center justify-between mx-auto">
        ...
        <button
          onClick={toggleMenu}
          type="button"
          className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 text-black"
